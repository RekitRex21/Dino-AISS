...
impl Default for KnowledgeBase {
    fn default() -> Self {
        ...
        patterns.insert("unsafe_cliPath".to_string(), PatternEntry {
        ...
        patterns.insert("sandbox_mode_off".to_string(), PatternEntry {
        ...
        patterns.insert("lan_bind_no_auth".to_string(), PatternEntry {
        ...
        patterns.insert("weak_token".to_string(), PatternEntry {
